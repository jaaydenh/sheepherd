...
public class GhostMove : MonoBehaviour {
	...
	public float movementError = 1.05f;
	// set this high enough to deal with sheepshake but low enough that they still respond to threats :)
	...
	void FixedUpdate () {	
		...
		if (netVector.magnitude > movementError) rigidbody2D.MovePosition(target);
